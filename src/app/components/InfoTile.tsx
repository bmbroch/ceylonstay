...
export default function InfoTile() {
  return (
    <div className="p-1 bg-wavy-border rounded-lg">
      <Card className="w-full bg-white/50 backdrop-blur-sm relative overflow-hidden">
        ...
        <CardContent className="h-full flex flex-col py-6 px-4 sm:py-8 sm:px-6 relative z-10">
          {/* Hero Content */}
